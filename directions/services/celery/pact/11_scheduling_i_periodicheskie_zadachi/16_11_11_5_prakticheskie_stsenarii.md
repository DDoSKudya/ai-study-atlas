...
Ниже — те же формулировки, что в `celery_mastery_plan.md` (блок «Проверь себя (11.5)»); ответы совпадают с **п. 1–3** в конце файла, в разделе [«Вопросы для самопроверки»](#вопросы-для-самопроверки).
