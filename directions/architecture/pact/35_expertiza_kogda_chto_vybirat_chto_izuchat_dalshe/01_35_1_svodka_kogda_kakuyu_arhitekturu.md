...
Важно: полный перечень архитектурных вариантов (чтобы не “забыть” релевантный способ) смотри в глобальном плане в разделе **«Карта всех архитектур»** (`mastery_plan.md`). В выборе полезно держать привычку: *“мы правда рассмотрели все разумные альтернативы под наш контекст?”*
